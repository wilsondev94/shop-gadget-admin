...
type Props = {
  ...
  setCurrentProduct: Dispatch<
    SetStateAction<CreateOrUpdateProductValues | null>
  >;
...
export const ProductTableRow = ({
  ...
  const handleEditClick = (product: CreateOrUpdateProductValues) => {
    setCurrentProduct({
      title: product.title,
        ...
        <Button
          ...
          onClick={() =>
            setCurrentProduct({
              title: product.title,
              category: product.category.id.toString(),
              price: product.price?.toString() ?? product.heroImage,
              maxQuantity: product.maxQuantity.toString(),
              images: [],
              slug: product.slug,
              intent: "update",
